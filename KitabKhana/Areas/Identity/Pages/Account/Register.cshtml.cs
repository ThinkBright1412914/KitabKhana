...
namespace KitabKhana.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        //    }
            ...
            Input = new InputModel()
            {
                ...
                CompanyList = _unitOfWork.Company.GetAll().Select(y => new SelectListItem
                {
                    Text = y.Name,
                    Value = y.Id.ToString(),
                }),
        ...
        public async Task<IActionResult> OnPostAsync(string? returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(Input.Role == RoleDefine.Role_Company_User)
                {
                ...
                if (result.Succeeded)
                {
                    ...
                    if(Input.Role == null)
                    {
                        await _userManager.AddToRoleAsync(user, RoleDefine.Role_User_Only);
                    }
                    else
                    {
                    ...
                    {
                        if(User.IsInRole(RoleDefine.Role_Admin))
                        {
